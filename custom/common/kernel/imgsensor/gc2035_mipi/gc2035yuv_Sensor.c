...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0xad , 0x7a);//90
	GC2035_write_cmos_sensor(0xae , 0x80);//90	
	GC2035_write_cmos_sensor(0xaf , 0x80);//90	
  ...
  /////////awb end /////////////
	...
	GC2035_write_cmos_sensor(0x2d , 0x06);//  level 2 10 6a7
	...
	GC2035_write_cmos_sensor(0xa5 , 0x75);
	GC2035_write_cmos_sensor(0xa6 , 0x77);
	GC2035_write_cmos_sensor(0xa7 , 0x77);
	GC2035_write_cmos_sensor(0xa8 , 0x67);
	...
	GC2035_write_cmos_sensor(0xaf , 0x12);
	GC2035_write_cmos_sensor(0xb0 , 0x00);
	GC2035_write_cmos_sensor(0xb1 , 0x0b);
	GC2035_write_cmos_sensor(0xb2 , 0x15);
	GC2035_write_cmos_sensor(0xb3 , 0x07);
	GC2035_write_cmos_sensor(0xb4 , 0x01);
	GC2035_write_cmos_sensor(0xb5 , 0x0b);
	GC2035_write_cmos_sensor(0xb6 , 0x3b);
	GC2035_write_cmos_sensor(0xb7 , 0x3b);
	GC2035_write_cmos_sensor(0xb8 , 0x29);
	GC2035_write_cmos_sensor(0xb9 , 0x1d);
	GC2035_write_cmos_sensor(0xba , 0x20);
	GC2035_write_cmos_sensor(0xbb , 0x12);
	GC2035_write_cmos_sensor(0xbc , 0x40);
	GC2035_write_cmos_sensor(0xbd , 0x29);
	GC2035_write_cmos_sensor(0xbe , 0x33);
	GC2035_write_cmos_sensor(0xbf , 0x1b);
	GC2035_write_cmos_sensor(0xc0 , 0x14);
	GC2035_write_cmos_sensor(0xc1 , 0x21);
	GC2035_write_cmos_sensor(0xc2 , 0x28);
	GC2035_write_cmos_sensor(0xc3 , 0x21);
	GC2035_write_cmos_sensor(0xc4 , 0x1e);
	GC2035_write_cmos_sensor(0xc5 , 0x12);
	GC2035_write_cmos_sensor(0xc6 , 0x0f);
	GC2035_write_cmos_sensor(0xc7 , 0x16);
	GC2035_write_cmos_sensor(0xc8 , 0x28);
	GC2035_write_cmos_sensor(0xc9 , 0x1c);
	GC2035_write_cmos_sensor(0xca , 0x1d);
	GC2035_write_cmos_sensor(0xcb , 0x25);
	GC2035_write_cmos_sensor(0xcc , 0x0f);
	GC2035_write_cmos_sensor(0xcd , 0x20);
	GC2035_write_cmos_sensor(0xd0 , 0x20);
	GC2035_write_cmos_sensor(0xd2 , 0x09);
	GC2035_write_cmos_sensor(0xd3 , 0x18);
	GC2035_write_cmos_sensor(0xd4 , 0x26);
	GC2035_write_cmos_sensor(0xd6 , 0x34);
	GC2035_write_cmos_sensor(0xd7 , 0x15);
	GC2035_write_cmos_sensor(0xd8 , 0x3f);
	GC2035_write_cmos_sensor(0xda , 0x0f);
	GC2035_write_cmos_sensor(0xdb , 0x15);
	...
	GC2035_write_cmos_sensor(0xc1 , 0x48);  
	GC2035_write_cmos_sensor(0xc2 , 0xff);  
	...
	GC2035_write_cmos_sensor(0x86 , 0x27);//add for DPC travis 20140505   
	GC2035_write_cmos_sensor(0x8a , 0x33);//add for DPC travis 20140505 
	GC2035_write_cmos_sensor(0x8d , 0x85);//add for DPC travis 20140505 
	GC2035_write_cmos_sensor(0xa6 , 0xf0);//80//change for DPC travis 20140505
	...
	GC2035_write_cmos_sensor(0xd3 , 0x48);//contrast ?	
	...
	///////dndd///////////
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x88 , 0x18);//dn_b_base//15
	...
	GC2035_write_cmos_sensor(0x97 , 0x43);// edge effect//45
	////==============RGB Gamma 
	GC2035_write_cmos_sensor(0xfe , 0x02);
...
static void GC2035_Sensor_SVGA(void)
{
	...
	/////////subsample 800x600 /////////
	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0x21 , 0xbf);  //add for DPC travis 20140505  
	GC2035_write_cmos_sensor(0xfe , 0x00);	
...
static void GC2035_Sensor_2M(void)
{
	...
	/////////subsample 800x600 /////////
 	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0x21 , 0xdf);  //add for DPC travis 20140505 
	GC2035_write_cmos_sensor(0xfe , 0x00);		  	
	GC2035_write_cmos_sensor(0xc8 , 0x00);
...
BOOL GC2035_set_param_banding(UINT16 para)
{
    switch (para)
    {
		...
		GC2035_write_cmos_sensor(0x2b , 0x04);//  level 1 13.75
		GC2035_write_cmos_sensor(0x2c , 0x9b);  
		GC2035_write_cmos_sensor(0x2d , 0x06);//  level 2 10  //5a1
		GC2035_write_cmos_sensor(0x2e , 0xa7);  
		GC2035_write_cmos_sensor(0x2f , 0x07);//  level 3 7.5
		GC2035_write_cmos_sensor(0x30 , 0x2a); 
		GC2035_write_cmos_sensor(0xfe , 0x00);    
