...
#define GC5004_I31XFY_CHECKSUM_VALUE (0xf14258c0)
...
static void GC5004MIPI_Init_Settings(void)
{
	...
	//////////////////////   BLK   //////////////////////
	/////////////////////////////////////////////////////
	GC5004MIPI_write_cmos_sensor(0x40, 0x72); // 22 20140722
...
static void GC5004MIPIPreviewSettings(void)
{
	...
	GC5004MIPI_write_cmos_sensor(0x05, 0x03); //HB  1fa
...
#if 1//defined(ATA_TOOLS_FACTORY_SUPPORT)
UINT32 GC5004SetTestPatternMode(kal_bool bEnable)
{
	if(bEnable)
	{
        GC5004MIPI_write_cmos_sensor(0xfe, 0x00);
        GC5004MIPI_write_cmos_sensor(0xb3, 0x40);//AWB gain
        GC5004MIPI_write_cmos_sensor(0xb4, 0x40);//AWB gain
        GC5004MIPI_write_cmos_sensor(0xb5, 0x40);//AWB gain
        GC5004MIPI_write_cmos_sensor(0xb1, 0x50);//Auto_pregain_sync[9:6]
        GC5004MIPI_write_cmos_sensor(0xb2, 0x01);//Auto_pregain[5:0]
        GC5004MIPI_write_cmos_sensor(0x03, 0x00);//Exposure
        GC5004MIPI_write_cmos_sensor(0x04, 0x00);   
        GC5004MIPI_write_cmos_sensor(0x8c, 0x01);//test pattern
        GC5004MIPI_write_cmos_sensor(0x8d, 0x18);
	}
	else
	{
        GC5004MIPI_write_cmos_sensor(0xfe,0x00);
        GC5004MIPI_write_cmos_sensor(0x8c,0x00);	
	}
	return ERROR_NONE;
}
#endif
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    #if 1//defined(ATA_TOOLS_FACTORY_SUPPORT)
	static UINT32 checkSumNum=0;
	//UINT32 gc5004CheckSumValue[]={GC5004_I31XFY_CHECKSUM_VALUE};
    #endif
	switch (FeatureId)
	{
		...
		case SENSOR_FEATURE_SET_TEST_PATTERN:			 
			GC5004SetTestPatternMode((BOOL)*pFeatureData16);			 
			break;
		/*case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE:
			SENSORDB("Enter in SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE\n");	
			SENSORDB("The value of checkSumNum is %x\n",checkSumNum);
			if(checkSumNum<(sizeof(gc5004CheckSumValue)/sizeof(UINT32))){
				*pFeatureReturnPara32=gc5004CheckSumValue[checkSumNum];
				*pFeatureParaLen=4;
				checkSumNum++;
			}else{
				checkSumNum=0;
			...
			SENSORDB("The value of checkSumNum is %x\n",checkSumNum);
			SENSORDB("The value of GC5004_TEST_PATTERN_CHECKSUM is %x\n",*pFeatureReturnPara32);
			SENSORDB("Exit out SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE\n");	
			break;
		
		case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_NUM:
			SENSORDB("Enter in SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_NUM\n");
			checkSumNum=0;
			*pFeatureReturnPara32=sizeof(gc5004CheckSumValue)/sizeof(UINT32);
			*pFeatureParaLen=4;
			SENSORDB("The value of pFeatureReturnPara32 is %x\n",*pFeatureReturnPara32);
			SENSORDB("The value of checkSumNum is %x\n",checkSumNum);
			SENSORDB("Exit out SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_NUM\n");
			break;*/
		case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE:
			//SENSORDB("Enter in SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE\n");  
                        //SENSORDB("The value of checkSumNum is %x\n",checkSumNum);
                        //SENSORDB("The value of pFeatureReturnPara32 is %x\n",*pFeatureReturnPara32);
			*pFeatureReturnPara32=GC5004_I31XFY_CHECKSUM_VALUE;
            		*pFeatureParaLen=4;
			break;
