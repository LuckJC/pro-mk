...
static void OV5648MIPI_Sensor_Init(void)
{
    ...
    */
    ...
    // Horizontal binning
    OV5648MIPI_write_cmos_sensor(0x3820, 0x06); // flip off, v bin off
//gyong     OV5648MIPI_write_cmos_sensor(0x3821, 0x07); // mirror on, h bin on
    OV5648MIPI_write_cmos_sensor(0x3821, 0x01); // mirror on, h bin on  0x01
...
static void OV5648MIPI_Capture_Setting(void)
{
    ...
    OV5648MIPI_write_cmos_sensor(0x3817, 0x00); // hsync start
//gyong    OV5648MIPI_write_cmos_sensor(0x3820, 0x40); // flip off, v bin off
    OV5648MIPI_write_cmos_sensor(0x3820, 0x06); // flip off, v bin off
//gyong    OV5648MIPI_write_cmos_sensor(0x3821, 0x06); // mirror on, v bin off
    OV5648MIPI_write_cmos_sensor(0x3821, 0x01); // mirror on, v bin off
