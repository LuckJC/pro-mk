...
UINT32 OV8865_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); //xianliang sign
...
UINT32 BF3905_MIPI_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);//xianliang add
UINT32 GC5004_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);//xianliang add
UINT32 GC2355MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);//xianliang add

UINT32 GC2035_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);  //add by xianliang
UINT32 OV5693_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); //add by mokj
...
#if defined(OV8825_MIPI_RAW_2LANE_P201) //lingjinming
...
#if defined(OV8865_MIPI_RAW_P201)//lingjinming
    {OV8865_SENSOR_ID, SENSOR_DRVNAME_OV8865_MIPI_RAW, OV8865_MIPI_RAW_SensorInit}, 
#endif

//add by xianliang start
#if defined(OV8865_MIPI_RAW)
    {OV8865_SENSOR_ID, SENSOR_DRVNAME_OV8865_MIPI_RAW, OV8865_MIPI_RAW_SensorInit}, 
#endif
//add by xianliang end
...
#if defined(OV5693_MIPI_RAW_P201)//lingjinming
    {OV5693_SENSOR_ID, SENSOR_DRVNAME_OV5693_MIPI_RAW, OV5693_MIPI_RAW_SensorInit}, 
#endif
...
#if defined(GC5004MIPI_RAW_XFY)
    {GC5004_MIPI_SENSOR_ID, SENSOR_DRVNAME_GC5004_MIPI_RAW, GC5004_MIPI_RAW_SensorInit}, 
#endif//xianliang add
#if defined(GC2355_XFY)
    {GC2355MIPI_SENSOR_ID, SENSOR_DRVNAME_GC2355MIPI_RAW, GC2355MIPI_RAW_SensorInit}, 
#endif//xianliang add

#if defined(GC2035_MIPI_P201) //lingjinming 
    {GC2035_SENSOR_ID, SENSOR_DRVNAME_GC2035_MIPI_YUV, GC2035_YUV_SensorInit},
#endif

#if defined(GC2035_MIPI)
    {GC2035_SENSOR_ID, SENSOR_DRVNAME_GC2035_MIPI_YUV, GC2035_YUV_SensorInit},
#endif
