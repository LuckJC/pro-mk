...
#define FRAME_HEIGHT 										(1280)	//854)	//jessen
...
{0x31,1,{0x02}},  //lingjinming 2014 09 05 //{0x31,1,{0x00}},//02
...
{0x53,1,{0x27}},//lingjinming 2014 09 05 //{0x53,1,{0x32}},//22
...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dsi.mode   = SYNC_EVENT_VDO_MODE;  //lingjinming //SYNC_PULSE_VDO_MODE;
...
#else
	printk("ili9806e 0x%x , 0x%x , 0x%x, 0x%x \n", id_high, id_midd, id_low, id);
#endif
...
//lingjinming modify for kk yin wei du ID you wenti xian paizai hou 2014 09 04
...
LCM_DRIVER ili9806e_boe_vdo_lcm_drv = 
{
    .name			= "ili9806e_boe_vdo",
