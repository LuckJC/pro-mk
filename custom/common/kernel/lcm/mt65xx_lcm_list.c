...
extern LCM_DRIVER ili9807_xfy_lcm_drv;
extern LCM_DRIVER otm9605_xfy_lcm_drv;

extern LCM_DRIVER ili9806e_boe_vdo_lcm_drv;  //lingjinming 2014 08 27 
...
//lingjinming add 2014 09 03 yi dao hou mian
#if defined(OTM8018B_DSI_VDO_P201)	
...
#if defined(ILI9807_XFY)
  &ili9807_xfy_lcm_drv,
#endif
#if defined(OTM9605_XFY)
  &otm9605_xfy_lcm_drv,
#endif

//lingjinming add 2014 08 28
#if defined(ILI9806E_BOE_VDO_P201)
		&ili9806e_boe_vdo_lcm_drv,
#endif
//lingjinming 

//lingjinming add 2014 08 27

#if defined(ILI9806E_BOE_VDO)
		&ili9806e_boe_vdo_lcm_drv,
#endif

#if defined(ILI9806E_YXW_YLT)
		&ili9806e_dsi_vdo_ylt_lcm_drv,
#endif
//lingjinming
...
#if 0 //defined(NT35520_HD720_DSI_CMD_TM) | defined(NT35520_HD720_DSI_CMD_BOE) | defined(NT35521_HD720_DSI_VDO_BOE) | defined(NT35521_HD720_DSI_VIDEO_TM)  //modify by xianliang
#ifdef BUILD_LK
