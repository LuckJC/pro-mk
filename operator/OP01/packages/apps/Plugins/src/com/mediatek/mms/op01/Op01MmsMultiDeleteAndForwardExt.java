...
//        Drawable MenuIcon = 
//            getResources().getDrawable(R.drawable.ic_menu_forward);
//        
//        mMenuForward = base + 1;
//        menu.add(0, mMenuForward, 0, getString(R.string.menu_forward)).setIcon(
//            MenuIcon);
//        
//        Xlog.d(TAG, "Add Menu: " + getString(R.string.menu_forward));
//        
//        item = menu.findItem(mMenuForward);
